module Rongcloud
  module Service
    ...
    API_URI = {
        ...
        USER_GROUP_JOIN: '/group/join.json',
        USER_GROUP_DISMISS: '/group/dismiss.json',
        USER_GROUP_SYNC: '/group/sync.json',
        USER_GROUP_REFRESH: '/group/refresh.json',
        ...
        MSG_GROUP_QUIT: '/group/quit.json'
    }
